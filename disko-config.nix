...
let
  ...
  let
    ...
    deviceMap = lib.listToAttrs (
      map (index: {
        name = "main${toString index}";
        value = {
          type = "disk";
    ...
    #_ = builtins.trace "devices: ${devices}" devices;
    #_ = builtins.trace "deviceCount: ${deviceCount}" deviceCount;
    #_ = builtins.trace "partitionsForDevice: ${partitionsForDevice}" partitionsForDevice;
    #_ = builtins.trace "deviceMap: ${deviceMap}" deviceMap;
